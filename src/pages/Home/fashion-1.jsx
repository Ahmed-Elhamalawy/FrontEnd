          ...
          <section>
            <div className="flex flex-col grid-cols-1 items-center justify-center gap-8">
              ...
              <span className="flex items-center gap-10">
                ...
                <NavLink to={"/Special Offer"}>Special Offer</NavLink>
              </span>
            </div>
            <div>
              <div>
                <AllProducts limit={"4"} category={"men's clothing"} />
              </div>
              <div>
                <AllProducts limit={"4"} category={"women's clothing"} />
              </div>
              <div>
                <AllProducts limit={"4"} category={"jewelery"} />
              </div>
              <div>
                <AllProducts limit={"4"} category={"electronics"} />
              </div>
            </div>
